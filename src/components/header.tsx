    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="h-9 bg-[#F5F5F5]">
        <div className="max-w-[1440px] mx-auto h-full flex justify-between items-center px-8 text-xs">
          <Image src={"/topDivIcon.png"} alt={"Icon"} width={24} height={24} className="ml=[48px] hidden md:block animate__animated animate__backInDown"></Image>

          {/* nav */}
          <nav className="hidden md:flex items-center gap-4 animate__animated animate__backInDown">
            <Link href="#" className="hover:text-gray-600">Find a Store</Link>
            <span className="text-gray-300">|</span>
            <Link href="/contact-us" className="hover:text-gray-600 cursor-help">Help</Link>
            <span className="text-gray-300">|</span>
