            ...
            <section>
              ...
              <div className="my-8">
                ...
                <div className="flex gap-4">
                  <Button className="rounded-full hover:bg-white hover:text-black">JOIN US</Button>
                  <Button className="rounded-full hover:bg-white hover:text-black">SHOP NIKE</Button>
                </div>
              </div>
